...
namespace test3
{
    class ReadWord
    {
        ...
        {
            string fileName = @"E:\作业\CSharp\CSharp\test3\国考_原题.docx";
        ...
        {
            string fileName = @"E:\作业\CSharp\CSharp\test3\国考_标准答案1.docx";
        ...
        {
            string fileName = @"E:\作业\CSharp\CSharp\test3\国考_标准答案2.docx";
            using (WordprocessingDocument wordprocessingDocument =
            WordprocessingDocument.Open(fileName, false))
            {
                // Create a Body object.
        ...
        {
            string fileName = @"E:\作业\CSharp\CSharp\test3\国考_标准答案3.docx";
            using (WordprocessingDocument wordprocessingDocument =
            WordprocessingDocument.Open(fileName, false))
            {
                // Create a Body object.
